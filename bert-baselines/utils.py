# Modified version of utils script
# Source: https://github.com/huggingface/transformers/blob/v2.7.0/src/transformers/data/processors/utils.py
...
class DataProcessor(object):
    ...
    def get_example_from_tensor_dict(self, tensor_dict):
        ...
        Args:
            tensor_dict: Keys and values should match the corresponding Alue
    ...
    def tfds_map(self, example):
        """Some tensorflow_datasets datasets are not formatted the same way the ALUE datasets are.
    ...
    def _read_tsv(cls, input_file, quotechar=None, delimiter="\t"):
        """Reads a delimiter separated value file."""
        with open(input_file, "r", encoding="utf-8-sig") as f:
            return list(csv.reader(f, delimiter=delimiter, quotechar=quotechar))

    @classmethod
    def _write_tsv(cls, output_file, rows, quotechar=None, delimiter=","):
        """Writes a delimiter separated value file."""
